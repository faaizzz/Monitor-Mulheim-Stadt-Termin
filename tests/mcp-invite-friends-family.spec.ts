...
test('invite friends and family - Verpflichtungserklärung', async ({ page }) => {
  ...
  // 3. Expand the section of Allgemeine Ausländerangelegenheiten
  await page.getByRole('tab', { name: 'Allgemeine Ausländerangelegenheiten' }).click();

  // 4. Click on the plus button of Abgabe einer Verpflichtungserklärung
  await page.getByRole('button', { name: 'Erhöhen der Anzahl des Anliegens Abgabe einer Verpflichtungserklärung' }).click();
